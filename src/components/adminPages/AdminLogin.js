        ...
        <div className="text-center m-5-auto pt-2" id='userLogin'>
            ...
            <form action="/home">
                <p>
                    ...
                    <input style={{border:'2px solid rgb(32, 31, 31)'}} type="text" name="first_name" required />
                </p>
                <p>
                ...
                <Link to="/AdminForgetPasswordPage"><label className="right-label text-white solid" id='forgot'>forget password?</label></Link>
            </form>
            <footer>

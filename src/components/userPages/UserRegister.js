        ...
        <body className="mx-auto mt-0 pt-0 m-blank p-auto" style={{ backgroundColor: '#1A374D' }}>
            ...
            <div className="container py-3 pt-0 pb-2" >
                ...
                <div className="text-center m-3-auto pt-1 mb-1" id='userLogin'>
                    ...
                    <form action="/home">
                        ...
                        <div className="row g-2">
                            <div className="col-5">
                                ...
                                <input id="registerwidth" style={{ border: '2px solid rgb(32, 31, 31)' }} type="text" className="form-control" id="validationTooltip01" required />
                        ...
                        <div className="col-6">
                                ...
                                <br />
                                <input style={{ border: '2px solid rgb(32, 31, 31)' }} type="text"  className="form-control"  name="password" required />
                        ...
                        <div className="col-6">
                            ...
                            <input style={{ border: '2px solid rgb(32, 31, 31)' }} className="form-control" type="number" pattern="[7-9]{1}[0-9]{9}" required />
                    ...
                    <footer>
                        <p><b>Allready registered?</b>  <Link to="/UserLogin"><b>Login</b></Link>.</p>
